...
function buildChart(container: HTMLElement, sticky: HTMLElement | null): ChartInstance {
  ...
  function render(data: CStep[]) {
    ...
    entering.append('text').attr('class', 'bl')
      .attr('x', 0)
      .attr('y', LABEL_H - 3)
    ...
    entering.append('rect').attr('class', 'br')
    ...
    entering.append('text').attr('class', 'bm')
      .attr('x', multX)
      .attr('dominant-baseline', 'auto')
      .attr('text-anchor', 'start')
      .attr('font-family', 'inherit')
    ...
    entering.append('text').attr('class', 'bv')
      .attr('x', multX)
    ...
    merged.select<SVGRectElement>('.br').transition(t)
      .attr('y', bY).attr('height', bh)
